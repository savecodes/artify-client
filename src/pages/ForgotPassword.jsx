  ...
  return (
    <div className="w-full flex items-center py-15">
      <div className="w-10/12 mx-auto flex justify-center">
        <form className="w-full max-w-md backdrop-blur-xl bg-white/40 dark:bg-gray-900/40 border border-white/30 dark:border-gray-700/40 rounded-2xl p-8 shadow-2xl">
          {/* Title */}
