...
import AllArtworksCard from "../features/gallery/components/AllArtworksCard";
          ...
          <div className="p-0.5 rounded-lg bg-linear-to-r from-pink-500 to-purple-600">
            <div className="relative bg-white dark:bg-gray-800 rounded-lg">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none"
                value={search}
